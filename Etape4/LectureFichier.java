...
public class LectureFichier
{
	...
	private void lireMotClee(String ligne)
	{
		String[] mots = ligne.split(" ");

		this.nomClasse = mots[2];
		String motCle = mots[4];

		if (mots[3].equals("implements"))
		{
			this.mapImplements.put(this.nomClasse, motCle);
		}

		if (mots[3].equals("extends"))
		{
			this.mapExtends.put(this.nomClasse, motCle);
		}
	}
