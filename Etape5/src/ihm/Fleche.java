...
public class Fleche extends JPanel 
{
	...
	private void dessinerLigneAvecPointes(Graphics2D g2, Point p1, Point p2, Bloc a, Bloc b)
	{
		...
		if (panelPrincipal.getAssociation(this) == null)
		{
			// IMPLEMENTS ?
			if (panelPrincipal.getImple(a) != null &&
				panelPrincipal.getImple(a).contains(panelPrincipal.getNomClasse(b)))
			{
			...
			// HERITAGE ?
			if (panelPrincipal.getNomClasse(b)
					.equals(panelPrincipal.getHerit(a)))
			{
				dessinerTriangleBlanc(g2, p1, p2);
				return;
			}
